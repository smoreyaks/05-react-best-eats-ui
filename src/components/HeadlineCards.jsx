        ...
        <div className='rounded-xl relative'>
          {/* Overlay */}
            ...
            <div className='rounded-xl relative'>
                ...
                <img
                    className='max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl'
                    src="https://images.pexels.com/photos/3745523/pexels-photo-3745523.jpeg" 
                    alt="/" />
            </div>
            ...
            <div className='rounded-xl relative'>
                ...
                <img
                    className='max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl'
                    src="https://images.pexels.com/photos/13177921/pexels-photo-13177921.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" 
                    alt="/" />
            </div>
        </div>
    )
