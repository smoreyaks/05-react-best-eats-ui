            ...
            <div className='flex flex-col lg:flex-row justify-between'>
                ...
                <div className=''>
                    ...
                    <div className='flex justify-start flex-wrap w-full pt-1'>
                        ...
                        <button onClick={()=> filterType('burger')} className='m-1 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white'>Burgers</button>
                        ...
                        <button onClick={()=> filterType('salad')} className='m-1 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white'>Salads</button>
                ...
                <div>
                    ...
                    <div className='flex justify-start max-w-[390px] w-full pt-1'>
                        <button onClick={()=> setFoods(data)} className='m-1 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white'>Any</button>  
                ...
                { foods.map((item, index) => (
                    <div key={ index } className='border shadow-lg hover:scale-105 duration-300 rounded-lg'>
                        ...
                        <div className='flex justify-between px-2 py-4'>
                            ...
                            <p>
                                <span className='bg-orange-500 text-white p-1 px-4 rounded-full w-10 font-bold'>{ item.price }</span>
                            </p>
                        </div>
                    </div>
                ))}
